...
public class BooksController {
	...
	// localhost:8080/book/books/detail/3 이라고 Request가 오면 맨끝의 숫자 3을 Mapping주소의 {book_seq}위치에 Mapping 한다.
	// 매개변수에 설정된 PathVarriable에 따라 String id 변수에 3의 값이 할당되어 method에 전달된다.
