...
<%@ include file ="/WEB-INF/views/include/include-header.jspf" %> <!-- Header -->
	...
	<section id="main">
		<form method = "POST">
			...
			<div><input name ="bl_user" value = "${BLOG.bl_user}"         placeholder="사용자를 입력하세요"/></div>
			<div><input name ="bl_title" value = "${BLOG.bl_title}"       placeholder="제목을 입력하세요"/></div>
			<div><input name ="bl_contents" value = "${BLOG.bl_contents}" placeholder="내용을 입력하세요"/></div>
			<div>
